...
<div className="bg-white dark:bg-gray-800">
    <div className="relative px-4 py-6 overflow-hidden sm:px-6 sm:py-8 lg:p-12 xl:p-16">
        <h2 className="text-2xl font-semibold font-display text-black dark:text-white sm:text-3xl">
          Cooking Tips And Food Service Coming .. 
        </h2>
            ...
            <div className="hidden lg:block absolute inset-y-0 lg:left-2/3 xl:left-1/2 right-0">
                <picture>
                    <source srcSet="https://i.ibb.co/7QQt2YD/tips.jpg" type="image/webp"/>
                        <source srcSet="https://i.ibb.co/7QQt2YD/tips.jpg"/>
                            <img className="w-1/2 object-cover maw-w-44 mx-auto" src="https://i.ibb.co/7QQt2YD/tips.jpg" alt="shopping item"/>
                        </picture>
                    </div>
                </div>
            </div>
