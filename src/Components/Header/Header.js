             ...
             <div className="navbar bg-base-100 px-5 md:px-20 ">
                    ...
                    <div className="navbar-start ">
                     ...
                     <div className='hidden md:flex items-center gap-1'>
                         <Link to="/" ><img src="" alt="" className='w-16 h-10'/></Link>
                         <Link to="/" className="text-2xl font-bold text-orange-400 font-[Poppins]">Ranna Ghor</Link>
                    </div>
               </div>
                ...
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar tooltip tooltip-left" >
